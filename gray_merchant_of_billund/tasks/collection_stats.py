...
def collection_stats():
    ...
    print(f"Total purchase price: {my_collection.tot_purchase_price}")
    print(f"Total RRP price: {brickset_index.tot_rrp_available}")
    print(
    ...
    print("Bricklink current used avg price:")
    for lego_set in bricklink_index:
        ...
        if price_guide.aggregate_current_used:
            ...
            print(
                f"{lego_set.num}: {lego_set.name} ({lego_set.year}): {avg_price} € (PP: {my_collection[lego_set.num].purchase_price} €, {avg_price - my_collection[lego_set.num].purchase_price:.2f} €)"
            )
        else:
            print(
    ...
    print("Bricklink current new avg price:")
    for lego_set in bricklink_index:
        price_guide = lego_set.price_guide
